...
def run_migrations():
    ...
    try:
        ...
        with get_conn() as conn:
            ...
            try:
                # WHERE/JOIN/ORDER BY hot columns
                ...
                conn.execute("CREATE INDEX IF NOT EXISTS idx_requests_deleted ON requests(deleted_at)")
                ...
                conn.execute("CREATE INDEX IF NOT EXISTS idx_hospitals_governorate ON hospitals(governorate)")
                conn.execute("CREATE INDEX IF NOT EXISTS idx_notifications_user ON notifications(user_id, role, sector)")
                ...
                conn.execute("CREATE INDEX IF NOT EXISTS idx_notifications_event_key ON notifications(event_key)")
                conn.execute("CREATE INDEX IF NOT EXISTS idx_services_active_name ON services(active, name)")
            except Exception as e:
